...
//		Step 3: Determine Triangle Type
	...
	public static String validateInput(int a, int b, int c) {
		boolean c1, c2, c3;
	...
	public static String triangleType(Object _a, Object _b, Object _c) {
		...
		String strValidation = validateInput(a,b,c);
		
		if (strValidation.equalsIgnoreCase("valid")) {
